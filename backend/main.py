...
@app.post("/chat/conversations/{conversation_id}/messages", status_code=201)
...
@app.post("/chat/conversations/{conversation_id}/read")
...
@app.patch("/trips/{trip_id}/safety")
...
@app.patch("/trips/{trip_id}/waypoint-dwell")
